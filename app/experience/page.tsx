          ...
          {experience.map((exp: IExperience, index) => (
            ...
            >
              <motion.span 
                ...
                className="absolute flex items-center justify-center w-12 h-12 lg:w-20 lg:h-20 bg-white dark:bg-dark-secondary border border-gray-300 dark:border-gray-700/50 rounded-full -start-9 lg:-start-16 shadow-sm dark:shadow-lg dark:shadow-black/10"
              >
                <motion.img 
              ...
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.2 + index * 0.05, duration: 0.2 }}
                className="ml-6 lg:ml-10 p-4 lg:p-6 bg-white dark:bg-dark-secondary rounded-lg border border-gray-300 dark:border-gray-700/50 shadow-sm dark:shadow-lg dark:shadow-black/10"
              >

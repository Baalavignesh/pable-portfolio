        ...
        <ol className="flex gap-6 lg:gap-24 flex-col relative text-gray-500 border-s border-white lg:border-gray-200 mb-24">
          {experience.map((exp: IExperience, index) => {
            ...
            return (
              ...
              >
                <span className=" lg:absolute flex items-center justify-center w-16 h-16 lg:w-32 lg:h-32 bg-white border-2 border-gray-200 rounded-full lg:-start-16 ">
                  <img src={exp.logo} className="w-32 rounded-full"></img>
                </span>
                <div className="lg:ml-24 mt-3 flex flex-col lg:flex-row justify-between ">

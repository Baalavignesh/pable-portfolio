          ...
          >
            {project.tags.map((tag: string, index: number) => (
              <motion.div 
                ...
                className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-dark-secondary rounded-md border border-gray-300 dark:border-gray-800/50 text-sm text-gray-900 dark:text-white shadow-sm dark:shadow-lg dark:shadow-black/10"
              >
                {tagToImage[tag] ? (

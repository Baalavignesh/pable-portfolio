      ...
      <div className="h-screen flex flex-col items-center">
        {isLoaded && project ? (
          <>
            ...
            <div className="flex flex-col gap-8 mx-12 lg:w-3/4 2xl:w-1/2 fade-projects">
              ...
              <div className="flex flex-col w-full mt-24 ">
                <div className="flex gap-4 items-center justify-between">
                  ...
                  <div className="flex gap-1">
                    {project.other && (
                      <div
                        className="flex  items-center text-lg bg-gray-100 p-4 rounded-md  mr-4 cursor-pointer"
                        onClick={() => {
                    ...
                    <div
                      className="flex gap-4 items-center text-lg bg-gray-100 p-4 rounded-md  mr-12 cursor-pointer"
                      onClick={() => {

...
let allProjects: IProject[] = [
  {
    ...
    website: "https://bytimeapp.com/",
    appstore: "https://apps.apple.com/us/app/bytime-time-hub/id6747457512",
    when: "2026",
    featured: true,
  },
  {
    ...
    key: "Aegis",
    description:
      "Aegis is an AI Agent Governance Platform — an open-source firewall and observability layer for autonomous AI agents. It intercepts every tool call an AI agent makes, validates it against a developer-defined policy, and logs the decision before the action executes. Think of it as Cloudflare for AI Agents.",
    tags: ["Python", "FastAPI", "MongoDB", "React", "PyPI"],
    inspiration:
      "AI agents (LangChain, LangGraph, CrewAI, AutoGen) are increasingly autonomous — calling APIs, accessing databases, and making decisions on their own. But there's no standardized way to see what an agent is doing in real time, control what actions it can take, stop it when it deviates, or audit every decision after the fact. Aegis was built to fix that.",
    technologies:
      "Aegis is built as a Python SDK (sentinel-guardrails) that integrates into existing agent code with two decorators and a context manager. The backend uses FastAPI with MongoDB for policy storage and audit logging. The real-time governance dashboard is built with React. Python's contextvars enable context-based policy enforcement where the same tool behaves differently depending on which agent calls it.",
    what: "Aegis implements a three-tier security model where every agent action is evaluated against a policy with three outcomes: ALLOWED, BLOCKED, or REVIEW (held for human approval). Developers define whitelists of allowed actions while known-dangerous actions are hard-blocked. The SDK-first design requires no infrastructure changes — just pip install and annotate. Features include a real-time dashboard for monitoring, a kill-switch for instant agent shutdown, and a complete audit trail of every decision.",
    github: "https://github.com/Baalavignesh/Aegis",
    youtube: "https://www.youtube.com/watch?v=yV1fvGuSDU0",
    when: "2026",
    other: "https://devpost.com/software/aegis-irq42f",
    featured: true,
  },
  {
    title: "Pager 2077",
    ...
    youtube: "https://www.youtube.com/watch?v=f03pyZ7Q3pA",
    other: "https://devpost.com/software/pager-2077",
    when: "2025",
    featured: false,
  },
  // {
  ...
  //   youtube: "https://www.youtube.com/watch?v=lqVn8JcZ6rs",
  //   when: "2025",
  ...
  // },
  {
    ...
    youtube: "https://www.youtube.com/watch?v=h1Yd4YYL3EQ",
    when: "2024",
  ...
  //   youtube: "https://www.youtube.com/watch?v=RQsK3dMSqi4",
  //   when: "2024",
  ...
  },
  {
    ...
    youtube: "https://www.youtube.com/watch?v=Z1d8rlRH4zw",
    when: "2024",
  ...
  //   youtube: "https://www.youtube.com/watch?v=Lmo4kDVMPK8",
  //   when: "2023",
  //   featured: true,
  // },
  // {

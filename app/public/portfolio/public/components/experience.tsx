  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="flex gap-4 flex-col p-6 rounded-lg border mt-6 border-gray-300 dark:border-gray-800/50 w-full bg-white dark:bg-dark-secondary shadow-sm dark:shadow-lg dark:shadow-black/10"
      >

...
const AboutMe = () => {
  return (
    <motion.div 
      ...
      className="flex flex-col w-full h-fit p-4 rounded-lg border-gray-200/50 dark:border-gray-800/50 border shadow-sm dark:shadow-lg dark:shadow-black/10 bg-white dark:bg-dark-secondary"
    >
